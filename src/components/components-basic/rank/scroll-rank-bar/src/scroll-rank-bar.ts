 ...
 * @LastEditTime : 2023-12-01 17:03:58
 */
...
export class ScrollRankBarSeries extends DatavChartSeries {
  public config
  constructor(name: string, param = {}) {
    super('ScrollRankBar', name)
    this.config = {
 ...
 * ScrollRankBar
 */
export class ScrollRankBar extends DatavEChartsComponent {
  config = {
    generate: {
    ...
    series: [new ScrollRankBarSeries('TOP1')],
  } as any
  ...
  constructor() {
    super('ScrollRankBar', { w: 500, h: 300 })
