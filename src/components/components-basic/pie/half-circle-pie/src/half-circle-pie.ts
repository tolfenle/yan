 ...
 * @LastEditTime : 2023-11-23 12:05:07
 */
 ...
 * HalfCirclePie
 */
export class HalfCirclePie extends DatavEChartsComponent {
  config = {
    generate: {
    ...
    pie: useChartPieConfig({ startAngle: 180 }),
  } as any
  ...
  constructor() {
    super('HalfCirclePie', { w: 340, h: 240 })
