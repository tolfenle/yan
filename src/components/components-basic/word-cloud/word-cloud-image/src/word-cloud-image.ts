 ...
 * @description  :
 * @updateInfo   :
 * @Date         : 2023-12-12 18:41:16
 * @LastEditTime : 2023-12-12 18:43:46
 */
 ...
 * WordCloudImage
 */
export class WordCloudImage extends DatavComponent {
  config = {
    ...
    imageMask: '/public/com-pickure/word-cloud.png',
  }
  ...
  constructor() {
    super('WordCloudImage', { w: 542, h: 431 })
  ...
  initData() {
    const fields = [
      ...
      createField('z', { description: '图片地址', optional: true }),
    ]
