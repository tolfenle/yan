...
export { default as IconModel } from './model.vue'
export { default as IconAi } from './ai.vue'
export { default as IconNavMedia } from './nav-media.vue'
export { default as IconNavMap } from './nav-map.vue'
export { default as IconProject } from './project.vue'
export { default as IconMoreVh } from './more-vh.vue'
